...
export default function ServiceCard({ icon, title, description }: Services) {
  return (
    <div className="full-shadow px-4 pb-4 h-fit md:h-[325px] w-[300px] 2xl:w-[350px] xl:h-[400px] 2xl:h-[450px] border border-grey flex flex-col items-center justify-start gap-4 xl:gap-6 hover:bg-primary group">
