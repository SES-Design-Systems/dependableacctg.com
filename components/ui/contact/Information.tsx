...
export default function Information() {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[1fr_450px] gap-4 xl:max-w-fit">
      {/* Left group: CallUs, Visit, Email */}
      <div className="grid grid-cols-1 gap-4 md:max-w-2xl place-items-center">
        <CallUs />
        <Visit />
      </div>
      ...
      <iframe
        ...
        className="w-full h-[500px] md:max-w-2xl xl:w-full"
        allowFullScreen
        loading="lazy"
