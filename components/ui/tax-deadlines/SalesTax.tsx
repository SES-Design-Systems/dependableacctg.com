  ...
  return (
    <section className="section-container !pt-0 !pb-0 flex flex-col items-center justify-center">
      ...
      <p className="text-center max-w-xs md:max-w-lg">
        All employees and subcontractors must recieve their tax documents
        (W-2&apos;s &amp; 1099&apos;s)
          ...
          <tr className="border border-b border-grey/20">
            ...
            <th className="w-1/2 p-4 text-left text-primary flex gap-2 items-center">
              ...
              <select
                ...
                className="bg-white border border-grey/20 rounded p-1 cursor-pointer"
              >
          ...
          {activeState === "FL" ? (
            <tr>
              <td colSpan={2} className="p-4 text-center">
                <p>
                  Florida sales tax is a monthly filing only, due on or before the
                  18th of each month.
                </p>
              </td>
            </tr>
            ...
            <>
              <tr className="border-b border-grey/20 hover:bg-primary/5">
                ...
                <td className="p-4 border-l border-grey/20 bg-grey/10">3/20</td>
              </tr>
              <tr className="border-b border-grey/20 hover:bg-primary/5">
                <td className="p-4">March-May</td>
                <td className="p-4 border-l border-grey/20 bg-grey/10">6/20</td>
              </tr>
              <tr className="border-b border-grey/20 hover:bg-primary/5">
                <td className="p-4">June-Aug</td>
                <td className="p-4 border-l border-grey/20 bg-grey/10">9/20</td>
              </tr>
              <tr className="hover:bg-primary/5">
                <td className="p-4">Sep-Nov</td>
                <td className="p-4 border-l border-grey/20 bg-grey/10">
                  12/20
                </td>
              </tr>
            </>
            ...
            <>
              <tr className="border-b border-grey/20 hover:bg-primary/5">
                ...
                <td className="p-4 border-l border-grey/20 bg-grey/10">4/20</td>
              </tr>
              <tr className="border-b border-grey/20 hover:bg-primary/5">
                <td className="p-4">April-June</td>
                <td className="p-4 border-l border-grey/20 bg-grey/10">7/20</td>
              </tr>
              <tr className="border-b border-grey/20 hover:bg-primary/5">
                <td className="p-4">July-Sept</td>
                <td className="p-4 border-l border-grey/20 bg-grey/10">10/20</td>
              </tr>
              <tr className="hover:bg-primary/5">
                <td className="p-4">Oct-Dec</td>
                <td className="p-4 border-l border-grey/20 bg-grey/10">1/20</td>
              </tr>
            </>
          )}
        </tbody>
